...
public class RestaurantListManager {
    ...
    public RestaurantListManager(Context context) {
    ...
    private void startGettingListInBackground(){
        ...
        JobInfo jobInfo = new JobInfo.Builder(Constants.JOB_ID, new ComponentName(context.getApplicationContext(), MyJobService.class))
//                .setMinimumLatency(0)
